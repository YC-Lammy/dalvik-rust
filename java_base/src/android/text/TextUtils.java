...
public class TextUtils {
    ...
    public static CharSequence listEllipsize(@Nullable Context context,
            ...
            @NonNull TextPaint paint, float avail,
            int moreId) {
        if (elements == null) {
            return "";
        }
     ...
     */
    @Nullable
    public static <T extends CharSequence> T trimToSize(@Nullable T text, int size) {
        assert (size > 0);
     ...
     */
    @Nullable
    public static <T extends CharSequence> T trimToLengthWithEllipsis(@Nullable T text, int size) {
     ...
     */
    public static @NonNull CharSequence makeSafeForPresentation(@NonNull String unclean,int maxCharactersToConsider,
            float ellipsizeDip, @SafeStringFlags int flags) {
        ...
        assert (unclean !=null);
        assert (maxCharactersToConsider >= 0);
        assert (ellipsizeDip>=0) :"ellipsizeDip";
        assert ((flags & SAFE_STRING_FLAG_TRIM & SAFE_STRING_FLAG_SINGLE_LINE & SAFE_STRING_FLAG_FIRST_LINE) != 0);
        assert (!(onlyKeepFirstLine && forceSingleLine)):
