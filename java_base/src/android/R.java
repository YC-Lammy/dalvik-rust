...
public final class R extends Object{
    ...
    public static final class anim extends Object{
    ...
    public static final class animator extends Object{
        public static final int fade_in = 0x010b0000;
        public static final int fade_out = 0x010b0001;
    }

    public static final class array extends Object {
        public array(){};
        ...
        public static final int config_displayUniqueIdArray = 0x01070005;
    }

    public static final class attr extends Object{
        public attr(){};
        ...
        public static final int lineBreakStyle = 0x0101064d;
        public static final int lineBreakWordStyle = 0x0101064e;
        ...
        public static final int allowGameAngleDriver = 0;
        public static final int allowGameDownscaling = 0;
        public static final int allowGameFpsOverride = 0;
        public static final int allowUntrustedActivityEmbedding = 0;
        public static final int autoHandwritingEnabled = 0;
        public static final int canDisplayOnRemoteDevices = 0;
        public static final int enableOnBackInvokedCallback = 0;
        public static final int fromExtendBottom = 0;
        public static final int fromExtendLeft = 0;
        public static final int fromExtendRight = 0;
        public static final int fromExtendTop = 0;
        public static final int inheritKeyStoreKeys = 0;
        public static final int intro = 0;
        public static final int knownActivityEmbeddingCerts = 0;
        public static final int localeConfig = 0;
        public static final int preferKeepClear = 0;
        public static final int requiredSplitTypes = 0;
        public static final int resetEnabledSettingsOnAppDataCleared = 0;
        public static final int sharedUserMaxSdkVersion = 0;
        public static final int showBackground = 0;
        public static final int showClockAndComplications = 0;
        public static final int splitTypes = 0;
        public static final int supportedTypes = 0;
        public static final int supportsBatteryGameMode = 0;
        public static final int supportsInlineSuggestionsWithTouchExploration = 0;
        public static final int supportsPerformanceGameMode = 0;
        public static final int supportsStylusHandwriting = 0;
        public static final int tileService = 0;
        public static final int toExtendBottom = 0;
        public static final int toExtendLeft = 0;
        public static final int toExtendRight = 0;
        public static final int toExtendTop = 0;
        public static final int useTargetActivityForQuickAccess = 0;
        public static final int windowSplashScreenBehavior = 0;
    ...
    public static final class id{
        ...
        public static final int accessibilityActionShowSuggestions = 0;
        public static final int accessibilityActionSwipeDown = 0;
        public static final int accessibilityActionSwipeLeft = 0;
        public static final int accessibilityActionSwipeRight = 0;
        public static final int accessibilityActionSwipeUp = 0;
        public static final int inputExtractAccessories = 0;
        public static final int inputExtractAction = 0;
    ...
    public static final class integer{
        ...
        public static final int config_cursorWindowSize = 0x010e0004;
    }
    ...
    public static final class style{
        ...
        public static final int TextAppearance_DeviceDefault_Headline = 0;
    }
    ...
    public static final class styleable {
        ...
        public static final int AndroidManifestActivity_allowUntrustedActivityEmbedding = 0x0000003e;
        ...
        public static final int AndroidManifestActivity_canDisplayOnRemoteDevices = 0x0000003d;
        ...
        public static final int AndroidManifestActivity_knownActivityEmbeddingCerts = 0x0000003f;
        ...
        public static final int AndroidManifestApplication_enableOnBackInvokedCallback = 0x0000004a;
        ...
        public static final int AndroidManifestApplication_knownActivityEmbeddingCerts = 0x00000049;
        ...
        public static final int AndroidManifestApplication_localeConfig = 0x00000048;
        ...
        public static final int AndroidManifestApplication_resetEnabledSettingsOnAppDataCleared = 0x00000047;
        ...
        public static final int AndroidManifest_inheritKeyStoreKeys = 0x00000010;
        ...
        public static final int Animation_showBackground = 0x0000000d;
        ...
        public static final int InputMethod_supportsInlineSuggestionsWithTouchExploration = 0x0000000a;
        public static final int InputMethod_supportsStylusHandwriting = 0x00000009;
        ...
        public static final int QuickAccessWalletService_useTargetActivityForQuickAccess = 0x00000004;
        ...
        public static final int View_autoHandwritingEnabled = 0x00000072;
        ...
        public static final int View_preferKeepClear = 0x00000071;
        ...
        public static final int Window_windowSplashScreenBehavior = 0x00000043;
        ...
        public static final int[] AbsListView = new int[]{};
        public static final int[] AbsSpinner = new int[]{};
        public static final int[] AbsoluteLayout_Layout = new int[]{};
        public static final int[] AccelerateInterpolator = new int[]{};
        public static final int[] AccessibilityService = new int[]{};
        public static final int[] AccessibilityShortcutTarget = new int[]{};
        public static final int[] AccountAuthenticator = new int[]{};
        public static final int[] ActionBar = new int[]{};
        public static final int[] ActionBar_LayoutParams = new int[]{};
        public static final int[] ActionMenuItemView = new int[]{};
        public static final int[] ActionMode = new int[]{};
        public static final int[] ActivityChooserView = new int[]{};
        public static final int[] AdapterViewAnimator = new int[]{};
        public static final int[] AdapterViewFlipper = new int[]{};
        public static final int[] AdaptiveIconDrawableLayer = new int[]{};
        public static final int[] AidFilter = new int[]{};
        public static final int[] AidGroup = new int[]{};
        public static final int[] AidPrefixFilter = new int[]{};
        public static final int[] AlertDialog = new int[]{};
        public static final int[] AlphaAnimation = new int[]{};
        public static final int[] AnalogClock = new int[]{};
        public static final int[] AndroidManifest = new int[]{};
        public static final int[] AndroidManifestAction = new int[]{};
        public static final int[] AndroidManifestActivity = new int[]{};
        public static final int[] AndroidManifestActivityAlias = new int[]{};
        public static final int[] AndroidManifestAdditionalCertificate = new int[]{};
        public static final int[] AndroidManifestAllowPermission = new int[]{};
        public static final int[] AndroidManifestApplication = new int[]{};
        public static final int[] AndroidManifestAttribution = new int[]{};
        public static final int[] AndroidManifestAttributionInheritFrom = new int[]{};
        public static final int[] AndroidManifestCategory = new int[]{};
        public static final int[] AndroidManifestCompatibleScreensScreen = new int[]{};
        public static final int[] AndroidManifestData = new int[]{};
        public static final int[] AndroidManifestDenyPermission = new int[]{};
        public static final int[] AndroidManifestExtensionSdk = new int[]{};
        public static final int[] AndroidManifestFeatureGroup = new int[]{};
        public static final int[] AndroidManifestGrantUriPermission = new int[]{};
        public static final int[] AndroidManifestInstrumentation = new int[]{};
        public static final int[] AndroidManifestIntentFilter = new int[]{};
        public static final int[] AndroidManifestKeySet = new int[]{};
        public static final int[] AndroidManifestLayout = new int[]{};
        public static final int[] AndroidManifestLibrary = new int[]{};
        public static final int[] AndroidManifestMetaData = new int[]{};
        public static final int[] AndroidManifestOriginalPackage = new int[]{};
        public static final int[] AndroidManifestPackageVerifier = new int[]{};
        public static final int[] AndroidManifestPathPermission = new int[]{};
        public static final int[] AndroidManifestPermission = new int[]{};
        public static final int[] AndroidManifestPermissionGroup = new int[]{};
        public static final int[] AndroidManifestPermissionTree = new int[]{};
        public static final int[] AndroidManifestProcess = new int[]{};
        public static final int[] AndroidManifestProcesses = new int[]{};
        public static final int[] AndroidManifestProfileable = new int[]{};
        public static final int[] AndroidManifestProperty = new int[]{};
        public static final int[] AndroidManifestProtectedBroadcast = new int[]{};
        public static final int[] AndroidManifestProvider = new int[]{};
        public static final int[] AndroidManifestPublicKey = new int[]{};
        public static final int[] AndroidManifestQueries = new int[]{};
        public static final int[] AndroidManifestQueriesIntent = new int[]{};
        public static final int[] AndroidManifestQueriesPackage = new int[]{};
        public static final int[] AndroidManifestQueriesProvider = new int[]{};
        public static final int[] AndroidManifestReceiver = new int[]{};
        public static final int[] AndroidManifestRequiredFeature = new int[]{};
        public static final int[] AndroidManifestRequiredNotFeature = new int[]{};
        public static final int[] AndroidManifestResourceOverlay = new int[]{};
        public static final int[] AndroidManifestSdkLibrary = new int[]{};
        public static final int[] AndroidManifestService = new int[]{};
        public static final int[] AndroidManifestStaticLibrary = new int[]{};
        public static final int[] AndroidManifestSupportsInputInputType = new int[]{};
        public static final int[] AndroidManifestSupportsScreens = new int[]{};
        public static final int[] AndroidManifestUpgradeKeySet = new int[]{};
        public static final int[] AndroidManifestUsesConfiguration = new int[]{};
        public static final int[] AndroidManifestUsesFeature = new int[]{};
        public static final int[] AndroidManifestUsesLibrary = new int[]{};
        public static final int[] AndroidManifestUsesNativeLibrary = new int[]{};
        public static final int[] AndroidManifestUsesPackage = new int[]{};
        public static final int[] AndroidManifestUsesPermission = new int[]{};
        public static final int[] AndroidManifestUsesSdk = new int[]{};
        public static final int[] AndroidManifestUsesSdkLibrary = new int[]{};
        public static final int[] AndroidManifestUsesSplit = new int[]{};
        public static final int[] AndroidManifestUsesStaticLibrary = new int[]{};
        public static final int[] AnimatedImageDrawable = new int[]{};
        public static final int[] AnimatedRotateDrawable = new int[]{};
        public static final int[] AnimatedStateListDrawable = new int[]{};
        public static final int[] AnimatedStateListDrawableItem = new int[]{};
        public static final int[] AnimatedStateListDrawableTransition = new int[]{};
        public static final int[] AnimatedVectorDrawable = new int[]{};
        public static final int[] AnimatedVectorDrawableTarget = new int[]{};
        public static final int[] Animation = new int[]{};
        public static final int[] AnimationDrawable = new int[]{};
        public static final int[] AnimationDrawableItem = new int[]{};
        public static final int[] AnimationScaleListDrawable = new int[]{};
        public static final int[] AnimationSet = new int[]{};
        public static final int[] Animator = new int[]{};
        public static final int[] AnimatorSet = new int[]{};
        public static final int[] AnticipateInterpolator = new int[]{};
        public static final int[] AnticipateOvershootInterpolator = new int[]{};
        public static final int[] AppWidgetProviderInfo = new int[]{};
        public static final int[] ArcMotion = new int[]{};
        public static final int[] AutoCompleteTextView = new int[]{};
        public static final int[] AutofillService = new int[]{};
        public static final int[] AutofillService_CompatibilityPackage = new int[]{};
        public static final int[] BitmapDrawable = new int[]{};
        public static final int[] Button = new int[]{};
        public static final int[] CalendarView = new int[]{};
        public static final int[] ChangeBounds = new int[]{};
        public static final int[] ChangeTransform = new int[]{};
        public static final int[] CheckBoxPreference = new int[]{};
        public static final int[] CheckedTextView = new int[]{};
        public static final int[] Chronometer = new int[]{};
        public static final int[] ClipDrawable = new int[]{};
        public static final int[] ClipRectAnimation = new int[]{};
        public static final int[] ColorDrawable = new int[]{};
        public static final int[] ColorStateListItem = new int[]{};
        public static final int[] CompoundButton = new int[]{};
        public static final int[] ContactsDataKind = new int[]{};
        public static final int[] CycleInterpolator = new int[]{};
        public static final int[] DatePicker = new int[]{};
        public static final int[] DateTimeView = new int[]{};
        public static final int[] DecelerateInterpolator = new int[]{};
        public static final int[] DeviceAdmin = new int[]{};
        public static final int[] DialogPreference = new int[]{};
        public static final int[] Drawable = new int[]{};
        public static final int[] DrawableCorners = new int[]{};
        public static final int[] DrawableStates = new int[]{};
        public static final int[] DrawableWrapper = new int[]{};
        public static final int[] Dream = new int[]{};
        public static final int[] EdgeEffect = new int[]{};
        public static final int[] EditText = new int[]{};
        public static final int[] ExpandableListChildIndicatorState = new int[]{};
        public static final int[] ExpandableListGroupIndicatorState = new int[]{};
        public static final int[] ExpandableListView = new int[]{};
        public static final int[] ExtendAnimation = new int[]{};
        public static final int[] Extra = new int[]{};
        public static final int[] Fade = new int[]{};
        public static final int[] FastScroll = new int[]{};
        public static final int[] FontFamily = new int[]{};
        public static final int[] FontFamilyFont = new int[]{};
        public static final int[] Fragment = new int[]{};
        public static final int[] FragmentAnimation = new int[]{};
        public static final int[] FragmentBreadCrumbs = new int[]{};
        public static final int[] FrameLayout = new int[]{};
        public static final int[] FrameLayout_Layout = new int[]{};
        public static final int[] Gallery = new int[]{};
        public static final int[] GameModeConfig = new int[]{};
        public static final int[] GameService = new int[]{};
        public static final int[] GestureOverlayView = new int[]{};
        public static final int[] GlowPadView = new int[]{};
        public static final int[] GradientColor = new int[]{};
        public static final int[] GradientColorItem = new int[]{};
        public static final int[] GradientDrawable = new int[]{};
        public static final int[] GradientDrawableGradient = new int[]{};
        public static final int[] GradientDrawablePadding = new int[]{};
        public static final int[] GradientDrawableSize = new int[]{};
        public static final int[] GradientDrawableSolid = new int[]{};
        public static final int[] GradientDrawableStroke = new int[]{};
        public static final int[] GridLayout = new int[]{};
        public static final int[] GridLayoutAnimation = new int[]{};
        public static final int[] GridLayout_Layout = new int[]{};
        public static final int[] GridView = new int[]{};
        public static final int[] HorizontalScrollView = new int[]{};
        public static final int[] HostApduService = new int[]{};
        public static final int[] HostNfcFService = new int[]{};
        public static final int[] Icon = new int[]{};
        public static final int[] IconDefault = new int[]{};
        public static final int[] IconMenuView = new int[]{};
        public static final int[] ImageSwitcher = new int[]{};
        public static final int[] ImageView = new int[]{};
        public static final int[] InputExtras = new int[]{};
        public static final int[] InputMethod = new int[]{};
        public static final int[] InputMethodService = new int[]{};
        public static final int[] InputMethod_Subtype = new int[]{};
        public static final int[] InsetDrawable = new int[]{};
        public static final int[] Intent = new int[]{};
        public static final int[] IntentCategory = new int[]{};
        public static final int[] Keyboard = new int[]{};
        public static final int[] KeyboardLayout = new int[]{};
        public static final int[] KeyboardView = new int[]{};
        public static final int[] KeyboardViewPreviewState = new int[]{};
        public static final int[] Keyboard_Key = new int[]{};
        public static final int[] Keyboard_Row = new int[]{};
        public static final int[] Keyframe = new int[]{};
        public static final int[] KeyguardGlowStripView = new int[]{};
        public static final int[] LayerDrawable = new int[]{};
        public static final int[] LayerDrawableItem = new int[]{};
        public static final int[] LayoutAnimation = new int[]{};
        public static final int[] LevelListDrawableItem = new int[]{};
        public static final int[] LinearLayout = new int[]{};
        public static final int[] LinearLayout_Layout = new int[]{};
        public static final int[] ListPopupWindow = new int[]{};
        public static final int[] ListPreference = new int[]{};
        public static final int[] ListView = new int[]{};
        public static final int[] LocaleConfig_Locale = new int[]{};
        public static final int[] LockPatternView = new int[]{};
        public static final int[] Magnifier = new int[]{};
        public static final int[] MapView = new int[]{};
        public static final int[] MaterialProgressDrawable = new int[]{};
        public static final int[] MediaRouteButton = new int[]{};
        public static final int[] Menu = new int[]{};
        public static final int[] MenuGroup = new int[]{};
        public static final int[] MenuItem = new int[]{};
        public static final int[] MenuItemCheckedFocusedState = new int[]{};
        public static final int[] MenuItemCheckedState = new int[]{};
        public static final int[] MenuItemUncheckedFocusedState = new int[]{};
        public static final int[] MenuItemUncheckedState = new int[]{};
        public static final int[] MenuView = new int[]{};
        public static final int[] MessagingLinearLayout = new int[]{};
        public static final int[] MultiSelectListPreference = new int[]{};
        public static final int[] Nfcid2Filter = new int[]{};
        public static final int[] NinePatchDrawable = new int[]{};
        public static final int[] NumberPicker = new int[]{};
        public static final int[] OffHostApduService = new int[]{};
        public static final int[] OvershootInterpolator = new int[]{};
        public static final int[] PagedView = new int[]{};
        public static final int[] PathInterpolator = new int[]{};
        public static final int[] PatternPathMotion = new int[]{};
        public static final int[] Pointer = new int[]{};
        public static final int[] PointerIcon = new int[]{};
        public static final int[] PopupWindow = new int[]{};
        public static final int[] PopupWindowBackgroundState = new int[]{};
        public static final int[] Preference = new int[]{};
        public static final int[] PreferenceActivity = new int[]{};
        public static final int[] PreferenceFragment = new int[]{};
        public static final int[] PreferenceFrameLayout = new int[]{};
        public static final int[] PreferenceFrameLayout_Layout = new int[]{};
        public static final int[] PreferenceGroup = new int[]{};
        public static final int[] PreferenceHeader = new int[]{};
        public static final int[] PreferenceScreen = new int[]{};
        public static final int[] PrintService = new int[]{};
        public static final int[] ProgressBar = new int[]{};
        public static final int[] PropertyAnimator = new int[]{};
        public static final int[] PropertyValuesHolder = new int[]{};
        public static final int[] QuickAccessWalletService = new int[]{};
        public static final int[] QuickContactBadge = new int[]{};
        public static final int[] RadioGroup = new int[]{};
        public static final int[] RatingBar = new int[]{};
        public static final int[] RatingDefinition = new int[]{};
        public static final int[] RatingSystemDefinition = new int[]{};
        public static final int[] RecognitionService = new int[]{};
        public static final int[] RelativeLayout = new int[]{};
        public static final int[] RelativeLayout_Layout = new int[]{};
        public static final int[] ResolverDrawerLayout = new int[]{};
        public static final int[] ResolverDrawerLayout_LayoutParams = new int[]{};
        public static final int[] RestrictionEntry = new int[]{};
        public static final int[] RingtonePreference = new int[]{};
        public static final int[] RippleDrawable = new int[]{};
        public static final int[] RotateAnimation = new int[]{};
        public static final int[] RotateDrawable = new int[]{};
        public static final int[] ScaleAnimation = new int[]{};
        public static final int[] ScaleDrawable = new int[]{};
        public static final int[] ScrollView = new int[]{};
        public static final int[] SearchView = new int[]{};
        public static final int[] Searchable = new int[]{};
        public static final int[] SearchableActionKey = new int[]{};
        public static final int[] SeekBar = new int[]{};
        public static final int[] SeekBarPreference = new int[]{};
        public static final int[] SelectionModeDrawables = new int[]{};
        public static final int[] SettingInjectorService = new int[]{};
        public static final int[] ShapeDrawable = new int[]{};
        public static final int[] ShapeDrawablePadding = new int[]{};
        public static final int[] Shortcut = new int[]{};
        public static final int[] ShortcutCategories = new int[]{};
        public static final int[] Slide = new int[]{};
        public static final int[] SlidingDrawer = new int[]{};
        public static final int[] SlidingTab = new int[]{};
        public static final int[] SpellChecker = new int[]{};
        public static final int[] SpellChecker_Subtype = new int[]{};
        public static final int[] Spinner = new int[]{};
        public static final int[] StackView = new int[]{};
        public static final int[] StateListAnimatorItem = new int[]{};
        public static final int[] StateListDrawable = new int[]{};
        public static final int[] StateListDrawableItem = new int[]{};
        public static final int[] Storage = new int[]{};
        public static final int[] SuggestionSpan = new int[]{};
        public static final int[] Switch = new int[]{};
        public static final int[] SwitchPreference = new int[]{};
        public static final int[] SyncAdapter = new int[]{};
        public static final int[] SystemCodeFilter = new int[]{};
        public static final int[] T3tPmmFilter = new int[]{};
        public static final int[] TabWidget = new int[]{};
        public static final int[] TableLayout = new int[]{};
        public static final int[] TableRow = new int[]{};
        public static final int[] TableRow_Cell = new int[]{};
        public static final int[] TextAppearance = new int[]{};
        public static final int[] TextClock = new int[]{};
        public static final int[] TextSwitcher = new int[]{};
        public static final int[] TextToSpeechEngine = new int[]{};
        public static final int[] TextView = new int[]{};
        public static final int[] TextViewAppearance = new int[]{};
        public static final int[] TextViewMultiLineBackgroundState = new int[]{};
        public static final int[] Theme = new int[]{};
        public static final int[] TimePicker = new int[]{};
        public static final int[] ToggleButton = new int[]{};
        public static final int[] Toolbar = new int[]{};
        public static final int[] Toolbar_LayoutParams = new int[]{};
        public static final int[] Transition = new int[]{};
        public static final int[] TransitionManager = new int[]{};
        public static final int[] TransitionSet = new int[]{};
        public static final int[] TransitionTarget = new int[]{};
        public static final int[] TranslateAnimation = new int[]{};
        public static final int[] TvInputService = new int[]{};
        public static final int[] TvInteractiveAppService = new int[]{};
        public static final int[] TwoLineListItem = new int[]{};
        public static final int[] VectorDrawable = new int[]{};
        public static final int[] VectorDrawableClipPath = new int[]{};
        public static final int[] VectorDrawableGroup = new int[]{};
        public static final int[] VectorDrawablePath = new int[]{};
        public static final int[] VerticalSlider_Layout = new int[]{};
        public static final int[] VideoView2 = new int[]{};
        public static final int[] View = new int[]{};
        public static final int[] ViewAnimator = new int[]{};
        public static final int[] ViewDrawableStates = new int[]{};
        public static final int[] ViewFlipper = new int[]{};
        public static final int[] ViewGroup = new int[]{};
        public static final int[] ViewGroup_Layout = new int[]{};
        public static final int[] ViewGroup_MarginLayout = new int[]{};
        public static final int[] ViewStub = new int[]{};
        public static final int[] ViewSwitcher = new int[]{};
        public static final int[] ViewTag = new int[]{};
        public static final int[] VisibilityTransition = new int[]{};
        public static final int[] VoiceInteractionService = new int[]{};
        public static final int[] VoiceInteractionSession = new int[]{};
        public static final int[] VolumePreference = new int[]{};
        public static final int[] Wallpaper = new int[]{};
        public static final int[] WallpaperPreviewInfo = new int[]{};
        public static final int[] Window = new int[]{};
        public static final int[] WindowAnimation = new int[]{};
