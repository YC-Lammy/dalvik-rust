...
import android.util.internal.StatLogger;
 ...
 **/
/** 
 * The real ServiceManger is implemented in rust.
*/
public final class ServiceManager {
     ...
     * avoid logspam.
     */
    private static final long GET_SERVICE_SLOW_THRESHOLD_US_CORE = 10000;

    /**
     * Threshold in uS for a "slow" call, used on non-core UIDs. We use a more relax value to
     * avoid logspam.
     */
    private static final long GET_SERVICE_SLOW_THRESHOLD_US_NON_CORE = 50000;

    /**
     * We log stats logging ever this many getService() calls.
     */
    private static final int GET_SERVICE_LOG_EVERY_CALLS_CORE = 100;

    /**
     * We log stats logging ever this many getService() calls.
     */
    private static final int GET_SERVICE_LOG_EVERY_CALLS_NON_CORE = 200;
    ...
    static native IBinder nGetService(String name);
    static native void nAddService(String name, IBinder service, boolean allowIsolated);
    static native IBinder nCheckService(String name);
    static native boolean nIsDeclared(String name);
    private static native IBinder waitForServiceNative(@NonNull String name);
    static native String[] nGetDeclaredInstances(String iface);
    static native String[] nListServices();
    static native void nRegisterForNotifications(String name, Runnable callback);
    ...
    public static void addService(String name, IBinder service, boolean allowIsolated) {
        nAddService(name, service, allowIsolated);
    }
    ...
    public static IBinder checkService(String name) {
        try {
            return Binder.allowBlocking(nCheckService(name));
        } catch (Exception e) {
    ...
    public static String[] getDeclaredInstances(@NonNull String iface) {
        try {
            return nGetDeclaredInstances(iface);
        } catch (Exception e) {
     ...
     * @hide
     */
    public static void registerForNotifications(@NonNull String name, @NonNull Runnable callback) throws RemoteException {
        nRegisterForNotifications(name, callback);
    }
    ...
    */
    ...
    private static IBinder rawGetService(String name) throws RemoteException {
        ...
        final IBinder binder = nGetService(name);
