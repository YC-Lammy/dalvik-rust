...
public abstract class VibrationEffect implements Parcelable {
    ...
    public static final int EFFECT_TEXTURE_TICK = 6;
    ...
    public static VibrationEffect get(int effectId, boolean fallback) {
        VibrationEffect effect = new Composed(
                new PrebakedSegment(effectId, fallback, EFFECT_STRENGTH_MEDIUM));
        effect.validate();
        return effect;
    }
    ...
    public static final class Composition {
        ...
        @TestApi
        @NonNull
        public Composition addEffect(@NonNull VibrationEffect effect, int delay) {
            if (delay > 0) {
         ...
         */
        @NonNull
        public Composition addPrimitive(@PrimitiveType int primitiveId, float scale) {
         ...
         */
        @NonNull
        public Composition addPrimitive(@PrimitiveType int primitiveId, float scale, int delay) {
