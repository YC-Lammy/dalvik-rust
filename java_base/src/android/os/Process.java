...
public class Process {
            ...
            try {
                ...
                if (fd >= 0) {
                    try{
                        ...
                        pidfd = (FileDescriptor)cons.newInstance(fd);
            ...
            try {
                ...
                if (fd >= 0) {
                    ...
                    try{
                        ...
                        Constructor<FileDescriptor> cons = FileDescriptor.class.getDeclaredConstructor(int.class);
                        cons.setAccessible(true);
                        FileDescriptor f = (FileDescriptor)cons.newInstance(fd);
    ...
    public static @Nullable FileDescriptor openPidFd(int pid, int flags) throws IOException {
        ...
        try {
            ...
            Constructor<FileDescriptor> cons = FileDescriptor.class.getDeclaredConstructor(int.class);
            cons.setAccessible(true);
            FileDescriptor pidfd = (FileDescriptor)cons.newInstance(nativePidFdOpen(pid, flags));
            return pidfd;
