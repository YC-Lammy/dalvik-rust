...
import android.app.internal.IBatteryStats;
...
public class BatteryManager {
    ...
    public static final int BATTERY_PLUGGED_AC = 1; // = 1
    /** Power source is a USB port. */
    public static final int BATTERY_PLUGGED_USB = 2; // = 2
    /** Power source is wireless. */
    public static final int BATTERY_PLUGGED_WIRELESS = 4; // = 4

    public static final int BATTERY_PLUGGED_DOCK = 8;

    /** @hide */
    public static final int BATTERY_PLUGGED_ANY =
            BATTERY_PLUGGED_AC | BATTERY_PLUGGED_USB | BATTERY_PLUGGED_WIRELESS | BATTERY_PLUGGED_DOCK;
    ...
    static native long nQueryProperty(int id);
    ...
    public boolean isCharging() {
        return nQueryProperty(BATTERY_PROPERTY_STATUS) == BATTERY_STATUS_CHARGING;
    }
