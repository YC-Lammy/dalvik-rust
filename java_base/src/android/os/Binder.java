...
public class Binder implements IBinder {
    ...
    public void onShellCommand(@Nullable FileDescriptor in, @Nullable FileDescriptor out,
        ...
        try {
            ...
            PrintWriter pw = new PrintWriter(new FileOutputStream(err != null ? err : out));
        ...
        try (ParcelFileDescriptor inPfd = ParcelFileDescriptor.dup(in);
            ...
            PrintWriter pw = new PrintWriter(new FileOutputStream(err));
    ...
    public int handleShellCommand(@NonNull ParcelFileDescriptor in,
        ...
        PrintWriter pw = new PrintWriter(ferr);
