...
public class DropBoxManager {
    ...
    public static class Entry implements Parcelable, Closeable {
        ...
        public Entry(@NonNull String tag, long millis) {
         ...
         */
        public @Nullable String getText(int maxBytes) {
        ...
        public static final @android.annotation.NonNull Parcelable.Creator<Entry> CREATOR = new Parcelable.Creator<Entry>() {
    ...
    public void addFile(@NonNull String tag, @NonNull File file, @Flags int flags)
        ...
        try {
            ...
            addData(tag, s.readAllBytes(), flags);
        } catch (Exception e) {
            //throw e.rethrowFromSystemServer();
        }
    }
    ...
    public @Nullable Entry getNextEntry(String tag, long msec) {
        ...
        // Read Log permission are not given anyway, this function is not implamented
