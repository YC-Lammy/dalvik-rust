...
import android.util.SneakyThrow;
...
public final class Parcel {
    ...
    private static native void nativeFinalize(Parcel obj);
    ...
    // check is done in Java to allow using  calls for the success path.
