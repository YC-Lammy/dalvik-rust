...
public final class SQLiteDatabase extends SQLiteClosable {
     ...
     */
    public static final int OPEN_READWRITE = 0x0000000;          // update native code if changing
    ...
    private static SQLiteDatabase openDatabase(@NonNull String path,
            @NonNull OpenParams openParams) {
        assert (openParams != null): "OpenParams cannot be null";
    ...
    public static final class OpenParams {
        ...
        public static final class Builder {
            ...
            public Builder setLookasideConfig(final int slotSize, final int slotCount) {
                ...
                assert ((slotSize > 0 && slotCount > 0) || (slotCount == 0 && slotSize == 0)):
                        String.format("Invalid configuration: %d, %d", slotSize, slotCount);
            ...
            public Builder setIdleConnectionTimeout(long idleConnectionTimeoutMs) {
                assert (idleConnectionTimeoutMs >= 0):
