...
public final class SQLiteConnection implements CancellationSignal.OnCancelListener {
    ...
    private native void nativeOpen(String path, int openFlags, String label,
            boolean enableTrace, boolean enableProfile, int lookasideSlotSize,
            int lookasideSlotCount);
    private native void nativeClose();
    private native void nativeRegisterCustomScalarFunction(String name, UnaryOperator<String> function);
    private native void nativeRegisterCustomAggregateFunction(String name, BinaryOperator<String> function);
    private native void nativeRegisterLocalizedCollators(String locale);
    private native long nativePrepareStatement(String sql);
    private native void nativeFinalizeStatement(long statementPtr);
    private native int nativeGetParameterCount(long statementPtr);
    private native boolean nativeIsReadOnly(long statementPtr);
    private native int nativeGetColumnCount(long statementPtr);
    private native String nativeGetColumnName(long statementPtr,
            int index);
    private native void nativeBindNull(long statementPtr,
            int index);
    private native void nativeBindLong(long statementPtr,
            int index, long value);
    private native void nativeBindDouble(long statementPtr,
            int index, double value);
    private native void nativeBindString(long statementPtr,
            int index, String value);
    private native void nativeBindBlob(long statementPtr,
            int index, byte[] value);
    private native void nativeResetStatementAndClearBindings(long statementPtr);
    private native void nativeExecute(long statementPtr);
    private native long nativeExecuteForLong(long statementPtr);
    private native String nativeExecuteForString(long statementPtr);
    ...
    private native void nativeResetCancel(boolean cancelable);
    ...
    private void open() {
        ...
        try {
            nativeOpen(file, mConfiguration.openFlags,
    ...
    public void execute(String sql, Object[] bindArgs,
        ...
        try {
            ...
            try {
                ...
                try {
                    nativeExecute(statement.mStatementPtr);
                } finally {
    ...
    public long executeForLong(String sql, Object[] bindArgs,
        ...
        try {
            ...
            try {
                ...
                attachCancellationSignal(cancellationSignal);
                try {
                    long ret = nativeExecuteForLong(statement.mStatementPtr);
    ...
    public String executeForString(String sql, Object[] bindArgs,
        ...
        try {
            ...
            try {
                ...
                attachCancellationSignal(cancellationSignal);
                try {
                    String ret = nativeExecuteForString(statement.mStatementPtr);
                    mRecentOperations.setResult(ret);
                    return ret;
                } finally {
                    detachCancellationSignal(cancellationSignal);
    ...
    public int executeForChangedRowCount(String sql, Object[] bindArgs,
        ...
        try {
            ...
            try {
                ...
                attachCancellationSignal(cancellationSignal);
                try {
                    changedRows = nativeExecuteForChangedRowCount(statement.mStatementPtr);
                    return changedRows;
                } finally {
                    detachCancellationSignal(cancellationSignal);
                }
    ...
    public long executeForLastInsertedRowId(String sql, Object[] bindArgs,
        ...
        try {
            ...
            try {
                ...
                attachCancellationSignal(cancellationSignal);
                try {
                    return nativeExecuteForLastInsertedRowId(statement.mStatementPtr);
                } finally {
                    detachCancellationSignal(cancellationSignal);
                }
            } finally {
    ...
    private PreparedStatement acquirePreparedStatement(String sql) {
        ...
        final long statementPtr = nativePrepareStatement(sql);
        try {
            final int numParameters = nativeGetParameterCount(statementPtr);
            final int type = DatabaseUtils.getSqlStatementType(sql);
            final boolean readOnly = nativeIsReadOnly(statementPtr);
    ...
    private void releasePreparedStatement(PreparedStatement statement) {
        ...
        if (statement.mInCache) {
            try {
                nativeResetStatementAndClearBindings(statement.mStatementPtr);
            } catch (SQLiteException ex) {
    ...
    private void finalizePreparedStatement(PreparedStatement statement) {
        nativeFinalizeStatement(statement.mStatementPtr);
    ...
    private void attachCancellationSignal(CancellationSignal cancellationSignal) {
        if (cancellationSignal != null) {
            ...
            if (mCancellationSignalAttachCount == 1) {
                ...
                nativeResetCancel(true /*cancelable*/);
    ...
    private void detachCancellationSignal(CancellationSignal cancellationSignal) {
        if (cancellationSignal != null) {
            ...
            if (mCancellationSignalAttachCount == 0) {
                ...
                nativeResetCancel(false /*cancelable*/);
            }
        }
    }
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (DatabaseUtils.getTypeOfObject(arg)) {
                case Cursor.FIELD_TYPE_NULL:
                    nativeBindNull(statementPtr, i + 1);
                    break;
                case Cursor.FIELD_TYPE_INTEGER:
                    nativeBindLong(statementPtr, i + 1,
                            ((Number)arg).longValue());
                    break;
                case Cursor.FIELD_TYPE_FLOAT:
                    nativeBindDouble(statementPtr, i + 1,
                            ((Number)arg).doubleValue());
                    break;
                case Cursor.FIELD_TYPE_BLOB:
                    nativeBindBlob(statementPtr, i + 1, (byte[])arg);
                    break;
                ...
                default:
                    if (arg instanceof Boolean) {
                        ...
                        nativeBindString(statementPtr, i + 1, arg.toString());
                    }
                    break;
            }
        }
    ...
    void dumpUnsafe(Printer printer, boolean verbose) {
        ...
        if (verbose) {
            printer.println("  connectionPtr: 0x" + Long.toHexString(mNativePtr));
        }
    ...
    void collectDbStats(ArrayList<DbStats> dbStatsList) {
        ...
        int lookaside = nativeGetDbLookaside();
        long pageCount = 0;
        long pageSize = 0;
        try {
