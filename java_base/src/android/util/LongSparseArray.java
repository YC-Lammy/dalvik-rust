...
import android.util.internal.GrowingArrayUtils;
import android.util.internal.Preconditions;
import android.util.internal.function.LongObjPredicate;
...
public class LongSparseArray<E> implements Cloneable {
    ...
    public static class StringParcelling implements
            android.util.internal.Parcelling<LongSparseArray<String>> {
        @Override
