...
public class VpnService extends Service {
    ...
    /**
     * Use VpnManager since those methods are hidden and not available in VpnManager.
     */
    private static VpnManager getService() {
        return (VpnManager)ServiceManager.getService(Context.VPN_MANAGEMENT_SERVICE);
    }
