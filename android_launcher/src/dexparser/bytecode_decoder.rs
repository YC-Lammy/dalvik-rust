...
mod tests {
    ...
    fn it_can_decode_noop() {
        ...
        assert!(core::matches!(opcode, ByteCode::Nop));
    ...
    fn it_can_decode_return_void() {
        ...
        assert!(core::matches!(opcode, ByteCode::ReturnVoid));
    ...
    fn it_can_decode_move() {
        ...
        assert!(core::matches!(opcode, ByteCode::Move(d, s) if d == 0xB && s == 0x3));
    ...
    fn it_can_decode_move_from_16() {
        ...
        assert!(core::matches!(opcode, ByteCode::MoveFrom16(d, s) if d == 0xAA && s == 0x3412));
    ...
    fn it_can_decode_move_16() {
        ...
        assert!(core::matches!(opcode, ByteCode::Move16(d, s) if d == 0x01AA && s == 0x3412));
    ...
    fn it_can_decode_move_wide() {
        ...
        assert!(core::matches!(opcode, ByteCode::MoveWide(d, s) if d == 0xB && s == 0x3));
    ...
    fn it_can_decode_move_wide_from_16() {
        ...
        assert!(core::matches!(opcode, ByteCode::MoveWideFrom16(d, s) if d == 0xAA && s == 0x3412));
    ...
    fn it_can_decode_move_wide_16() {
        ...
        assert!(core::matches!(opcode, ByteCode::MoveWide16(d, s) if d == 0x01AA && s == 0x3412));
    ...
    fn it_can_decode_move_object() {
        ...
        assert!(core::matches!(opcode, ByteCode::MoveObject(d, s) if d == 0xB && s == 0x3));
    ...
    fn it_can_decode_move_object_from_16() {
        ...
        assert!(core::matches!(opcode, ByteCode::MoveObjectFrom16(d, s) if d == 0xAA && s == 0x3412));
    ...
    fn it_can_decode_move_object_16() {
        ...
        assert!(core::matches!(opcode, ByteCode::MoveObject16(d, s) if d == 0x01AA && s == 0x3412));
    ...
    fn it_can_decode_move_result() {
        ...
        assert!(core::matches!(opcode, ByteCode::MoveResult(d) if d == 0x3B));
    ...
    fn it_can_decode_move_result_wide() {
        ...
        assert!(core::matches!(opcode, ByteCode::MoveResultWide(d) if d == 0x12));
    ...
    fn it_can_decode_move_result_object() {
        ...
        assert!(core::matches!(opcode, ByteCode::MoveResultObject(d) if d == 0xFF));
    ...
    fn it_can_decode_move_exception() {
        ...
        assert!(core::matches!(opcode, ByteCode::MoveException(d) if d == 0x00));
    ...
    fn it_can_decode_return() {
        ...
        assert!(core::matches!(opcode, ByteCode::Return(d) if d == 0x23));
    ...
    fn it_can_decode_return_wide() {
        ...
        assert!(core::matches!(opcode, ByteCode::ReturnWide(d) if d == 0x23));
    ...
    fn it_can_decode_return_object() {
        ...
        assert!(core::matches!(opcode, ByteCode::ReturnObject(d) if d == 0x23));
    ...
    fn it_can_decode_const_4_neg() {
        ...
        assert!(core::matches!(opcode, ByteCode::Const4(r, i) if r == 0x1 && i == -1));
    ...
    fn it_can_decode_const_4_pos() {
        ...
        assert!(core::matches!(opcode, ByteCode::Const4(r, i) if r == 0x1 && i == 7));
    ...
    fn it_can_decode_const_16_neg() {
        ...
        assert!(core::matches!(opcode, ByteCode::Const16(r, i) if r == 0xF1 && i == -1030));
    }
    ...
    fn it_can_decode_const() {
        ...
        assert!(core::matches!(opcode, ByteCode::Const(r, i) if r == 0x44 && i == 64506));
    }
    ...
    fn it_can_decode_const_high_16() {
        ...
        assert!(core::matches!(opcode, ByteCode::ConstHigh16(r, i) if r == 0x44 && i == -65536));
    }
    ...
    fn it_can_decode_const_wide_16() {
        ...
        assert!(core::matches!(opcode, ByteCode::ConstWide16(r, i) if r == 0x44 && i == -1));
    }
    ...
    fn it_can_decode_const_wide_32() {
        ...
        assert!(core::matches!(opcode, ByteCode::ConstWide32(r, i) if r == 0x44 && i == 285_278_207));
    }
    ...
    fn it_can_decode_const_wide() {
        ...
        assert!(
            core::matches!(opcode, ByteCode::ConstWide(r, i) if r == 1 && i == 72_056_786_600_853_316)
        );
    }
    ...
    fn it_can_decode_monitor_enter() {
        ...
        assert!(core::matches!(opcode, ByteCode::MonitorEnter(r) if r == 1));
    }
    ...
    fn it_can_decode_monitor_exit() {
        ...
        assert!(core::matches!(opcode, ByteCode::MonitorExit(r) if r == 9));
    }
    ...
    fn it_can_decode_new_instance() {
        ...
        assert!(core::matches!(opcode, ByteCode::NewInstance(d, reference) if d == 0 && reference == 32));
    }
    ...
    fn it_can_decode_throw() {
        ...
        assert!(core::matches!(opcode, ByteCode::Throw(reg) if reg == 18));
    }
    ...
    fn it_can_decode_goto() {
        ...
        assert!(core::matches!(opcode, ByteCode::Goto(offset) if offset == 3));
    }
    ...
    fn it_can_decode_goto16() {
        ...
        assert!(core::matches!(opcode, ByteCode::Goto16(offset) if offset == 1027));
    }
    ...
    fn it_can_decode_goto32() {
        ...
        assert!(core::matches!(opcode, ByteCode::Goto32(offset) if offset == 100_992_003));
    }
    ...
    fn it_can_decode_unary_operation() {
        ...
        assert!(core::matches!(opcode, ByteCode::Unary(_, dest, src) if dest == 3 &&  src == 8));
    }
